...
self.gray = [128, 128, 128, 1];
self.grey = [128, 128, 128, 1];
self.green = [0, 128, 0, 1];
self.greenyellow = [173, 255, 47, 1];
self.honeydew = [240, 255, 240, 1];
self.hotpink = [255, 105, 180, 1];
self.indianred = [205, 92, 92, 1];
self.indigo = [75, 0, 130, 1];
self.ivory = [255, 255, 240, 1];
...
self.lightslategrey = [119, 136, 153, 1];
